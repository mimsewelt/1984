...
import (
	...
	"github.com/mimsewelt/1984/services/users/internal/handler"
...
func main() {
	...
	r.Get("/users/by-username/{username}", userH.GetProfileByUsername)
	...
	go func() {
		log.Info("users service listening", zap.String("addr", srv.Addr))
